...
<svg class="thermal-map-detail ${profile.name}" xmlns="http://www.w3.org/2000/svg" viewBox="${nederlandMap.viewBox}" role="img" aria-labelledby="${profile.name}-detail-title ${profile.name}-detail-desc">
  ...
  <defs>
    ...
    <style>
      svg{background:transparent}.coast-halo{fill:none;stroke:rgba(244,241,234,.28);stroke-width:5.2;stroke-linejoin:round;opacity:.16;filter:url(#line-glow)}.coast-line{fill:none;stroke:rgba(244,241,234,.46);stroke-width:1.7;stroke-linejoin:round;opacity:.28}.neighbor-context-halo{fill:none;stroke:rgba(33,70,139,.56);stroke-width:2.8;stroke-linecap:round;stroke-linejoin:round;stroke-dasharray:2.5 8.5;opacity:.1;filter:url(#line-glow)}.neighbor-context-line{fill:none;stroke:rgba(244,241,234,.58);stroke-width:1;stroke-linecap:round;stroke-linejoin:round;stroke-dasharray:2.2 7.2;opacity:.24}.neighbor-border-halo{fill:none;stroke:rgba(33,70,139,.68);stroke-width:4;stroke-linecap:round;stroke-linejoin:round;opacity:.24;filter:url(#line-glow)}.neighbor-border-line{fill:none;stroke:rgba(244,241,234,.76);stroke-width:1.55;stroke-linecap:round;stroke-linejoin:round;stroke-dasharray:12 12;opacity:.52}.water-cutout{fill:none;stroke:rgba(11,13,14,.9);stroke-width:5.6;stroke-linejoin:round;opacity:.94}.water-glow{fill:none;stroke:rgba(33, 70, 139, .5);stroke-width:2.3;stroke-linejoin:round;opacity:.54}.water-line-shadow{fill:none;stroke:rgba(5,5,6,.86);stroke-width:2.5;stroke-linecap:round;stroke-linejoin:round;opacity:.7}.water-line-signal{fill:none;stroke:rgba(33, 70, 139, .82);stroke-width:.95;stroke-linecap:round;stroke-linejoin:round;opacity:.82}.province-halo{fill:none;stroke:rgba(11,13,14,.68);stroke-width:3;stroke-linejoin:round;opacity:.42}.province-line{fill:none;stroke:rgba(244,241,234,.3);stroke-width:1;stroke-linejoin:round;opacity:.42}.scanner .water-line-signal{stroke-width:1.08;opacity:.9}.scanner .water-line-shadow{stroke-width:2.8}.scanner .neighbor-context-line{opacity:.3}.scanner .neighbor-border-line{opacity:.6}.ambient{opacity:.72}
    </style>
  </defs>
